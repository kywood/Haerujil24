...
class StateMeta:
    ...
    meta = {
        StateDefine.E_StateType.Consumer : {
            StateDefine.ConsumerState.E_STATE.Idle: Func(lambda StateController : IdleState(StateController)),
            StateDefine.ConsumerState.E_STATE.Dispatching: Func(lambda StateController : DispatchingState(StateController)),
...
class StateFactory:
    ...
    def CreateStateController(  state_type  : StateDefine.E_StateType):
        ...
        for state_id in StateMeta.meta[state_type].keys():
            ...
            stateController.AppendState(StateMeta.meta[state_type][state_id].Invoke(stateController))
